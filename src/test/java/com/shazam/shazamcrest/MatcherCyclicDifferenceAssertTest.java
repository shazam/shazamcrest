 ...
 */
public class MatcherCyclicDifferenceAssertTest {

    @Test(expected =ComparisonFailure.class )
    public void hasComparisonFailureOnDifferencesInCircularReferencedClasses() {

        final CircularReferenceBean expected = buildObjects("ExpectedParent", "ExpectedChild1", "ExpectedChild2");
        final CircularReferenceBean actual = buildObjects("ActualParent", "ActualChild1", "ActualChild2");
